    ...
    methods
        ...
        function  EvaluatingAll(optimizor,sub, map, gaConfig,chargers,randIndexes)
            ...
            for i=1:gaConfig.PopulationSize
                ...
                if i==randIndexes(1) && isempty(chargers(1).best_chromo)==0
            ...
            optimizor.record_dis_charging(optimizor.count)=optimizor.distance_charging(optimizor.bestIndividualIndex); 
        end % function
        ...
        function  EvaluatingCharging(optimizor,sub, map, gaConfig,chargers,randIndexes)
            optimizor.count=optimizor.count+1;
            optimizor.iteration(optimizor.count)=optimizor.count;
            ...
            for i=1:gaConfig.PopulationSize
                ...
                optimizor.fitness(i)=optimizor.distance_working(i)/optimizor.charging_enough(i)/optimizor.cover(i)/optimizor.charging_enough(i);
            end
            [optimizor.minimumFitness, optimizor.bestIndividualIndex] = min(optimizor.fitness);
            fprintf('Minimum Fitness: %d\n',optimizor.minimumFitness);
            fprintf('Minimum Fitness index: %d\n',optimizor.bestIndividualIndex);
        ...
        function plotall(obj,workers,chargers,gaConfig)
            ...
            obj.figure_handle3=semilogx(obj.iteration,obj.record_dis_charging);
            xlabel('iteration')
            ylabel('Chargers traveling distance')
